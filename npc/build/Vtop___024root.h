...
class Vtop___024root final : public VerilatedModule {
  public:
    ...
    CData/*1:0*/ top__DOT__exu_src_sel;
    CData/*3:0*/ top__DOT__lsu_opt;
    CData/*0:0*/ top__DOT__rdwen;
    CData/*0:0*/ top__DOT__a0zero;
    ...
    VlUnpacked<QData/*33:0*/, 4> top__DOT__u_exu__DOT__mux_src1__DOT__i0__DOT__pair_list;
    VlUnpacked<CData/*1:0*/, 4> top__DOT__u_exu__DOT__mux_src1__DOT__i0__DOT__key_list;
    VlUnpacked<IData/*31:0*/, 4> top__DOT__u_exu__DOT__mux_src1__DOT__i0__DOT__data_list;
    VlUnpacked<QData/*33:0*/, 4> top__DOT__u_exu__DOT__mux_src2__DOT__i0__DOT__pair_list;
    VlUnpacked<CData/*1:0*/, 4> top__DOT__u_exu__DOT__mux_src2__DOT__i0__DOT__key_list;
    VlUnpacked<IData/*31:0*/, 4> top__DOT__u_exu__DOT__mux_src2__DOT__i0__DOT__data_list;
